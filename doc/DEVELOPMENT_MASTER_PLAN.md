...
| IMP-6.2 DB 백업 · 복구 | ✅ 완료 (스모크 2검사 추가, 13 개정 1건 — 프로세스 판정을 두 번 틀렸다) | `PENDING` |
...
| 42 | IMP-6.3 | **실소켓 부하 시험** | — | M | tools | SPK-1은 **in-process 시뮬레이션**이다. WebSocket을 실제로 N개 열어 핸드셰이크·역압·메모리를 잰다 |
