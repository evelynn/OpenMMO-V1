...
그 밖에 남은 것은 **IMP-6.4(콘텐츠 확충)**, **IMP-6.5(여행 목적지 베이크)**,
그리고 **IMP-4.3(보류 확정)**이다.
...
| 43 | IMP-6.4 | **콘텐츠 확충** | 제품 판단 | L | data | 몬스터 레벨이 10에서 끝나 **플레이 아크가 레벨 12~13에서 닫힌다**(BETA_READINESS §3) |
